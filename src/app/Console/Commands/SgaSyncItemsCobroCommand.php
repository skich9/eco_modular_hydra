...
class SgaSyncItemsCobroCommand extends Command
{
	protected $signature = 'sga:sync-items-cobro {source=all : sga_elec|sga_mec|all} {--chunk=1000} {--dry-run}';
	protected $description = 'Sincroniza Items de Cobro desde SGA (sin_item_service) hacia la tabla local items_cobro';
